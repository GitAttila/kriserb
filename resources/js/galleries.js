		...
		$.getJSON(url)
                ...
                $($imagesToCheckContainer)
                    .imagesLoaded()
                        ...
                        .progress(function(instance, image) {
                            if (image.isLoaded) {
                                $('#content-spinner .progress-bar').width(instance.progressedCount / instance.images.length * 100 + '%');
                            } else {
                                brokenCount++;
                            }
                        });
			...
			.fail(function(err) {
				...
				$('#content-spinner .spinner-msg')
					...
					.html('Could not load the data gallery file.</br> Check console for more detail.');
			})
			.always(function() {
